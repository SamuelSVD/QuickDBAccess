...
namespace QuickDBAccess.Utils {
    class ArgUtils {
        ...
        public class ArgHandler {
            ...
            public ArgHandler(bool required, string flag, int paramCount, EventHandler eventHandler) {
        ...
        public static void Handle(string[] args) {
            ...
            foreach (ArgHandler handler in handlers) {
                if (handler.required && !handledHandlers.Contains(handler)) {
        ...
        private static bool HandleHandler(string[] args, List<int> handledParams, ArgHandler handler) {
            ...
            if (startedHandle) {
                if (parameters.Count == handler.paramCount) {
                    ...
                    MessageBox.Show("Insufficient parameters passed");
                }
            }
            return false;
        }
